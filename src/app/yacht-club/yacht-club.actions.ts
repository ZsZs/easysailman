...
export const yachtClubSaved = createAction( '[YACHT-CLUB] Yacht-club saved', props<{ yachtClub: YachtClub }>() );
export const deleteYachtClub = createAction( '[YACHT-CLUB] Delete yacht-club', props<{ yachtClubId: string }>() );
export const yachtClubDeleted = createAction( '[YACHT-CLUB] Yacht-club deleted', props<{ yachtClub: YachtClub }>() );
